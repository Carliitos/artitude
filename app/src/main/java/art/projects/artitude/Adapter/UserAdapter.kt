...
class UserAdapter(private var mContext: Context,private var mUser:List<User>,private var isFragment: Boolean=false,private var navController: NavController):RecyclerView.Adapter<UserAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: UserAdapter.ViewHolder, position: Int) {
        ...
        if(user.avatarUrl!=""){
            Picasso.get().load(user.avatarUrl).placeholder(R.drawable.profilenoimage).into(holder.userProfImage)
        }
